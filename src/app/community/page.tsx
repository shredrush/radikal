          ...
          <div className="grid gap-8 p-6 sm:p-8 md:grid-cols-[minmax(0,1fr)_minmax(19rem,1fr)] md:items-stretch md:gap-12 md:p-10">
            ...
            <aside className="rounded-[1.5rem] border border-border/70 bg-background/75 py-5 shadow-[0_18px_40px_-28px_rgba(15,23,42,0.45)] backdrop-blur-sm dark:bg-card/70 sm:py-6 md:-my-10 md:-mr-10 md:rounded-none">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3 px-5 sm:px-6">
                <div className="min-w-0 rounded-2xl bg-blue-50/80 p-3 text-left dark:bg-blue-500/10">
                  ...
                  <p className="mt-1.5 text-xs leading-5 text-muted-foreground">You bring the expertise. We help people discover it</p>
                </div>
                <div className="min-w-0 rounded-2xl bg-emerald-50/80 p-3 text-left dark:bg-emerald-500/10">
                  <div className="flex items-center gap-2.5">
                  ...
                  <p className="mt-1.5 text-xs leading-5 text-muted-foreground">Bookings, payments and scheduling handled, so you focus on trail</p>
                </div>
              </div>
            </aside>
          </div>
