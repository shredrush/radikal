...
export function SiteFooter() {
  return (
    <footer className="w-full border-t border-border/60 bg-[linear-gradient(135deg,#111111_0%,#1d1d1d_45%,#2f2f2f_100%)] px-4 py-6 text-white sm:px-6 sm:py-8 lg:px-8 lg:py-10">
