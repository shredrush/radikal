...
export function SiteFooter() {
  return (
    <footer className="w-full border-t border-border/60 bg-[linear-gradient(135deg,#1d4ed8_0%,#2563eb_38%,#c2410c_100%)] px-4 py-6 text-white sm:px-6 sm:py-8 lg:px-8 lg:py-10">
