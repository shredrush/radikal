...
export function SiteFooter() {
  return (
    <footer className="w-full border-t border-border/60 bg-background px-4 py-8 text-foreground sm:px-6 sm:py-10 lg:px-10 lg:py-14">
      <div className="mx-auto flex max-w-8xl flex-col gap-8 xl:flex-row xl:items-start xl:justify-between xl:gap-12">
        <div className="max-w-2xl flex-1">
          <p className="text-[clamp(0.72rem,0.85vw,0.86rem)] font-semibold uppercase tracking-[0.32em] text-orange-600/80">
            Radikal
          </p>
          <h4 className="mt-2 font-heading text-[clamp(1.1rem,4.4vw,2.3rem)] font-semibold leading-[1.1] tracking-wide text-foreground xl:whitespace-nowrap">
            Born in the Himalayas. Built for the outdoors.
          </h4>
          <p className="mt-3 max-w-[640px] text-[clamp(0.9rem,1.08vw,1.08rem)] leading-7 text-muted-foreground">
            Discover experiences led by trusted outdoor professionals—or build your own business on Radikal.
          </p>
        </div>

        <div className="flex w-full max-w-[360px] flex-shrink-0 justify-start xl:ml-10 xl:justify-end">
          <div className="w-full max-w-full space-y-3 text-left xl:max-w-[200px] xl:text-right">
